...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  !function(n) {
    ...
    var f = { setDataAttribute: function(t2, e2, n2) {
      t2.setAttribute("data-bs-".concat(on2(e2)), n2);
    }, removeDataAttribute: function(t2, e2) {
      t2.removeAttribute("data-bs-".concat(on2(e2)));
      ...
      return rn(t2.getAttribute("data-bs-".concat(on2(e2))));
    }, offset: function(t2) {
      ...
      datefocusin: function(event) {
        if (!document.getElementsByClassName("lightpick")[0]) {
          new Lightpick({
            ...
            onSelect: function(start2, end) {
              if (start2 != null) {
                let date = new Date(start2._d);
